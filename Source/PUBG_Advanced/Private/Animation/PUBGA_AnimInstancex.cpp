...
#include "Animation/PUBGA_AnimInstancex.h"
...
UPUBGA_AnimInstancex::UPUBGA_AnimInstancex() {



}

void UPUBGA_AnimInstancex::UpdateAnimationProperties(float DeltaTime) {

	if (ShooterCharacter == nullptr) {
		ShooterCharacter = Cast<APUBGA_Characterx>(TryGetPawnOwner());
	}
	if (ShooterCharacter) {
...
void UPUBGA_AnimInstancex::NativeInitializeAnimation() {
